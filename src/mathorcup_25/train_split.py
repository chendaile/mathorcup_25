...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Split dataset into train and validation folders')
...
def split_and_copy_files(img_file_list, input_label_path, train_num, val_num, 
                         train_img_path, train_txt_path, val_img_path, val_txt_path):
...
def main():
    ...
    split_and_copy_files(img_file_list, input_label_path, train_num, val_num,
                        train_img_path, train_txt_path, val_img_path, val_txt_path)
